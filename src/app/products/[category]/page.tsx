...
const products = {
  'stem-kit': [
    ...
    },
    {
      ...
      url: 'stem-kit/plug-play-robo-kit',
  ...
  6) 16 well defined sessions for Coding, Robotics & Science projects`,
    ...
    },
    {
      ...
      url:'stem-kit/jr-sr-combined-kit',
  ...
  'mini-pc':[
    ...
    },
    {
      ...
      url: 'mini-pc/thunder-a044504/a05605',
...
const CategoryPage = () => {
  ...
  console.log(pathname); // This will log the full path
